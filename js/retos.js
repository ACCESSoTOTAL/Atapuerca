...
const retos = [
  {
    ...
    descripcion: "Muestra todos los datos de la tabla Bases: BaseID, Nombre, Ubicación, TipoBase, Capacidad, Latitud y Longitud. Deben aparecer las 8 bases del sistema.",
  ...
  },
  {
    ...
    descripcion: "Selecciona solo las columnas Nombre y TipoBase de la tabla Bases, ordenándolas alfabéticamente por nombre. Resultado esperado: 8 filas ordenadas de A-Z.",
  ...
  },
  {
    ...
    descripcion: "De la tabla Bases, muestra todas las columnas pero solo para los registros donde TipoBase sea exactamente 'Humana'. Deben aparecer 5 bases.",
  ...
  },
  {
    ...
    descripcion: "Muestra todos los datos de la tabla Survivors: SurvivorID, Nombre, Edad, Rol, BaseID. Deben aparecer los 8 supervivientes del sistema.",
  ...
  },
  {
    ...
    descripcion: "Consulta la tabla Resources para ver todos los datos: ResourceID, BaseID, AguaLitros, ComidaRaciones, Armas y Medicinas. Deben aparecer 5 registros de recursos.",
  ...
  },
  {
    ...
    descripcion: "De la tabla Bases, muestra todas las columnas para los registros donde EsComandoCentral sea igual a '1'. Solo debe aparecer 1 base.",
  ...
  },
  {
    ...
    descripcion: "De la tabla Survivors, selecciona todas las columnas para supervivientes con Edad mayor a 30 años. Deben aparecer 4 supervivientes veteranos.",
  ...
  },
  {
    ...
    descripcion: "Usa INNER JOIN entre tablas Survivors (s) y Bases (b) conectadas por BaseID. Selecciona s.Nombre como Superviviente y b.Nombre como Base. Solo aparecerán supervivientes que tienen base asignada (6 registros).",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre tablas Bases (b) y Survivors (s) conectadas por BaseID. Selecciona b.Nombre como Base y s.Nombre como Superviviente. Aparecerán todas las 8 bases, incluso las que no tienen supervivientes asignados.",
  ...
  },
  {
    ...
    descripcion: "Usa RIGHT JOIN entre tablas Bases (b) y Survivors (s) conectadas por BaseID. Selecciona b.Nombre como Base y s.Nombre como Superviviente. Aparecerán todos los 8 supervivientes, incluso los que no tienen base asignada.",
  ...
  },
  {
    ...
    descripcion: "Usa FULL OUTER JOIN entre tablas Bases (b) y Survivors (s) conectadas por BaseID. Selecciona b.Nombre como Base y s.Nombre como Superviviente. Aparecerán tanto bases sin supervivientes como supervivientes sin base.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre tablas Bases (b) y Survivors (s) con WHERE s.BaseID IS NULL para encontrar bases sin supervivientes. Selecciona solo b.Nombre. Deben aparecer 4 bases vacías.",
  ...
  },
  {
    ...
    descripcion: "Usa RIGHT JOIN entre las tablas Bases y Survivors, pero con WHERE b.BaseID IS NULL para encontrar supervivientes sin base asignada. Selecciona solo s.Nombre. Deben aparecer 2 supervivientes huérfanos.",
  ...
  },
  {
    ...
    descripcion: "Usa CROSS JOIN entre tablas Bases (b) y Survivors (s) sin condición ON. Selecciona b.Nombre como Base y s.Nombre como Superviviente. Creará TODAS las combinaciones posibles: 8 bases × 8 supervivientes = 64 filas.",
  ...
  },
  {
    ...
    descripcion: "Conecta tres tablas en una consulta: Survivors (s) INNER JOIN Bases (b) ON s.BaseID=b.BaseID, luego LEFT JOIN Resources (r) ON b.BaseID=r.BaseID. Selecciona s.Nombre, b.Nombre y r.ComidaRaciones. Usa LEFT JOIN para Resources porque no todas las bases tienen recursos.",
  ...
  },
  {
    ...
    descripcion: "Usa alias s1 y s2 para hacer JOIN de la tabla Survivors consigo misma: s1 INNER JOIN s2 ON s1.Edad = s2.Edad AND s1.SurvivorID < s2.SurvivorID. Selecciona s1.Nombre, s2.Nombre y s1.Edad. Esto encuentra parejas de supervivientes con la misma edad (evitando duplicados).",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre tablas Survivors (s) y Bases (b) conectadas por BaseID. Selecciona s.Nombre, s.Rol, b.Nombre y b.TipoBase, ordenado por nombre de base. Deben aparecer 6 supervivientes con base asignada.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre tablas Bases (b) y Resources (r) conectadas por BaseID. Selecciona b.Nombre, y usa COALESCE para mostrar 0 en lugar de NULL para ComidaRaciones, AguaLitros y Armas. Ordena por nombre de base.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre tablas Bases (b) y Survivors (s) conectadas por BaseID, con WHERE b.EsComandoCentral = '1'. Selecciona b.Nombre, s.Nombre y s.Rol. Deben aparecer los 3 supervivientes del comando central.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre Bases (b) y Survivors (s), con CASE WHEN b.Latitud > 0 para clasificar hemisferios. Agrupa con GROUP BY y cuenta bases y supervivientes por hemisferio. Deben aparecer 2 filas: Norte y Sur.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre Survivors (s) y Bases (b), luego LEFT JOIN con Resources (r). Selecciona s.Nombre, s.Rol, b.Nombre y r.Armas (usa COALESCE para mostrar 0 si NULL). Ordena por armas descendente.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre Bases (b) y Survivors (s) conectadas por BaseID. Agrupa por b.Nombre y calcula COUNT de supervivientes y AVG de edad (usa CAST para convertir a FLOAT). Ordena por edad promedio descendente.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre tablas Bases (b) y Resources (r) conectadas por BaseID. Suma las columnas ComidaRaciones + AguaLitros + Armas + Medicinas. Ordena por total descendente y usa LIMIT 1 para obtener solo la base con más recursos.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre tablas Bases (b) y Survivors (s) conectadas por BaseID, con WHERE s.BaseID IS NULL para encontrar bases vacías. Selecciona b.Nombre y b.TipoBase. Deben aparecer 4 bases sin supervivientes.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre Survivors (s) y Bases (b) conectadas por BaseID, con WHERE s.Rol IN ('Comandante', 'Médica'). Selecciona s.Nombre, s.Rol, s.Edad y b.Nombre. Ordena por edad descendente. Deben aparecer 3 líderes.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre Bases (b) y Resources (r) conectadas por BaseID. Selecciona b.Nombre, r.ComidaRaciones, r.AguaLitros, calcula la diferencia absoluta con ABS(), y usa CASE WHEN para clasificar el balance. Ordena por diferencia ascendente.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN desde Bases (b) hacia Survivors (s) y Resources (r). Cuenta bases y supervivientes con COUNT(DISTINCT), suma recursos con SUM y COALESCE. Sin GROUP BY para obtener un resumen general en 1 fila.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre Bases (b) y Survivors (s), agrupa por b.BaseID, b.Nombre, b.TipoBase. Cuenta supervivientes con COUNT(s.SurvivorID) y usa RANK() OVER para crear ranking. Ordena por población descendente.",
  ...
  },
  {
    ...
    descripcion: "De la tabla Survivors, agrupa por s.Rol y calcula COUNT(*), AVG de edad (convertida a FLOAT), MIN edad y MAX edad. Ordena por cantidad descendente para identificar roles escasos.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN entre Bases (b) y Survivors (s), filtra WHERE b.Capacidad IS NOT NULL. Agrupa por base y calcula porcentaje de ocupación usando COUNT / Capacidad * 100. Usa NULLIF para evitar división por cero.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN desde Bases (b) hacia Survivors (s) y Resources (r). Agrupa por base y calcula recursos per cápita usando CASE WHEN para evitar división por cero. Incluye COUNT supervivientes, COALESCE para recursos NULL.",
  ...
  },
  {
    ...
    descripcion: "Usa CROSS JOIN en tabla Bases (b1, b2) con WHERE b1.BaseID < b2.BaseID para evitar duplicados. Selecciona nombres, coordenadas y calcula distancia aproximada con ABS de diferencias lat/lon. Ordena descendente, LIMIT 3.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN desde Bases (b) hacia Survivors (s) y Resources (r). Agrupa por base y calcula un índice de eficiencia combinando: supervivientes*10 + recursos totales/10 + capacidad/5. Usa COALESCE para manejar NULL.",
  ...
  },
  {
    ...
    descripcion: "De la tabla Survivors, usa CASE WHEN para clasificar por rangos de edad (< 20, 20-29, 30-39, 40+). Agrupa por rango y calcula COUNT, AVG de edad, y STRING_AGG para concatenar nombres con roles. Ordena por edad promedio.",
  ...
  },
  {
    ...
    descripcion: "Usa JOIN entre Bases (b1) y Resources (r1), luego CROSS JOIN con Bases (b2) y Resources (r2), con WHERE b1.BaseID != b2.BaseID. Compara recursos de comida, calcula diferencias con ABS y clasifica tipo de intercambio con CASE WHEN.",
  ...
  },
  {
    ...
    descripcion: "Usa CTE llamado BaseStats que hace LEFT JOIN desde Bases hacia Survivors y Resources, agrupa por TipoBase y calcula estadísticas promedio. Luego selecciona del CTE y agrega recomendaciones con CASE WHEN por tipo de base.",
  ...
  },
  {
    ...
    descripcion: "Encuentra la base con menos supervivientes pero que aún tenga gente asignada. Usa JOIN de Bases con Survivors, GROUP BY con HAVING que compare con subconsulta MIN. Debe mostrar nombre de base y número de supervivientes.",
  ...
  },
  {
    ...
    descripcion: "De Bases (b) con JOIN a Resources (r), selecciona nombre y recursos totales. Filtra con WHERE donde la suma sea mayor que subconsulta AVG de la suma de todos los recursos. Ordena por recursos totales descendente.",
  ...
  },
  {
    ...
    descripcion: "De Survivors (s) con JOIN a Bases (b), selecciona nombre, edad, rol y base. Filtra WHERE edad > subconsulta AVG de todas las edades Y rol sea 'Comandante' o 'Médica'. Ordena por edad descendente.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN de Bases (b) con Survivors (s), filtra WHERE capacidad IS NOT NULL. Agrupa por base y muestra nombre, capacidad, ocupantes actuales y espacio disponible (capacidad-ocupantes). HAVING para solo bases con espacio libre.",
  ...
  },
  {
    ...
    descripcion: "Usa LEFT JOIN de Bases (b) con Resources (r). Clasifica con CASE WHEN usando EXISTS para verificar si recursos >= 500 comida Y 500 agua ('Autónoma'), si existe cualquier recurso ('Dependiente'), sino 'Sin recursos'. Muestra también comida y agua con COALESCE.",
  ...
  },
  {
    ...
    descripcion: "De Survivors (s) con JOIN a Bases (b), selecciona nombre, edad, rol, base y característica especial. Usa CASE WHEN con subconsultas MAX/MIN para identificar edad extrema, o roles especiales ('Comandante', 'Médica'). Ordena por edad.",
  ...
  },
  {
    ...
    descripcion: "Usa dos CTEs: BasePopulation (LEFT JOIN Bases-Survivors agrupado) y StatsGenerales (AVG de supervivientes). Luego CROSS JOIN entre ambos CTEs y clasifica con CASE WHEN si sobrepoblada (>1.5x promedio), subpoblada (<0.5x), abandonada (0) o equilibrada.",
  ...
  },
  {
    ...
    descripcion: "Agrupa por zona geográfica usando CASE WHEN con latitud (>42 Norte, >35 Central, resto Sur). LEFT JOIN Bases-Survivors-Resources, calcula COUNT bases, supervivientes, SUM/AVG armas. Clasifica seguridad según ratio armas/supervivientes.",
  ...
  },
  {
    ...
    descripcion: "Dos CTEs: BasesOrigen (JOIN Bases-Survivors agrupado), BasesDestino (LEFT JOIN con HAVING para espacio libre). CROSS JOIN entre CTEs con WHERE origen≠destino. Muestra plan evacuación según capacidad disponible vs personas a evacuar.",
  ...
  },
  {
    ...
    descripcion: "Crea índice de supervivencia combinando múltiples factores con LEFT JOIN de Bases hacia Survivors y Resources. Calcula puntuación ponderada: supervivientes×peso + recursos×peso + capacidad×peso + factores geográficos.",
  ...
  },
  {
    ...
    descripcion: "Dos CTEs: ComandoCentral (LEFT JOIN múltiple, filtra WHERE EsComandoCentral='1', agrupa y calcula liderazgo/recursos) y StatsGlobales (promedio personal). CROSS JOIN entre CTEs, compara comando vs estadísticas globales.",
  ...
  },
  {
    ...
    descripcion: "CTE ConsumoSimulado: LEFT JOIN Bases-Survivors-Resources, calcula consumo diario (3 comida + 5 agua por superviviente). Proyecta duración recursos con división, usa NULLIF para evitar error, clasifica alertas según días restantes.",
  ...
  },
  {
    ...
    descripcion: "Dos CTEs: CapacidadMilitar (GROUP BY base, cuenta personal militar y armas) y EvaluacionDefensa (calcula puntuación según algoritmo: militar×2+armas si bien armados). UNION ALL agrega fila resumen total del asentamiento.",
  ...
  },
  {
    ...
    descripcion: "Dos CTEs: AnalisisRoles (GROUP BY rol, STRING_AGG para listas) y CriticidadRol (evalúa riesgo por cantidad: 1=crítico, 2=vulnerable, >2=estable). UNION ALL agrega fila resumen con COUNT DISTINCT roles y evaluación diversidad.",
  ...
  },
  {
    ...
    descripcion: "Tres CTEs: DistanciasEntreBases (CROSS JOIN con distancia euclidiana), CentroGeografico (AVG coordenadas), BasesCentrales (distancia al centro). UNION ALL múltiple para centro, base central, rutas extremas.",
  ...
  },
  {
    ...
    descripcion: "Tres CTEs: PerfilesBase (recursos per cápita), IntercambiosOptimos (CROSS JOIN calcula transferencias cuando diferencia >50), RankingIntercambios (ROW_NUMBER ordena por beneficio). UNION ALL agrega resumen económico.",
  ...
  },
  {
    ...
    descripcion: "Tres CTEs: LiderazgoActual (puntuación por rol), CandidatosSucesion (CROSS JOIN evalúa gaps), AnalisisCriticidad (GROUP BY rol analiza disponibilidad). Identifica mejores candidatos por mínima diferencia liderazgo.",
  ...
  },
  {
    ...
    descripcion: "Cuatro CTEs: BasesDatos (recursos totales), ZonasExpansion (UNION ALL genera coordenadas +1/-1), EvaluacionExpansion (algoritmo viabilidad: población×20+recursos/10-distancia×15), PlanExpansionGlobal (estadísticas). UNION ALL plan maestro.",
  ...
  },
  {
    ...
    descripcion: "Cinco CTEs complejos: BaselineActual (estado actual), ProyeccionDemografica (crecimiento poblacional), ProyeccionRecursos (sostenibilidad), AnalisisLiderazgo (continuidad), EscenariosFuturos (predicciones). CROSS JOIN múltiple integra todos los factores para proyectar 5 años.",
  ...
  },
  {
    ...
    descripcion: "De la tabla Robots, selecciona modelo, generación, funciones y nivel amenaza. Usa CASE WHEN para clasificar riesgo según nivel: ≥9 crítico, ≥7 alto, ≥5 medio, <5 bajo. Ordena por amenaza y generación descendente.",
  ...
  },
  {
    ...
    descripcion: "LEFT JOIN de Bases (b) con Attacks (a), agrupa por base. Cuenta ataques con COUNT, suma muertos con SUM, última fecha con MAX y concatena tipos robot con STRING_AGG. Ordena por ataques y muertes descendente.",
  ...
  },
  {
    ...
    descripcion: "De Missions (m), usa CASE WHEN con EXISTS para verificar si origen y destino están aliados (consulta Alliances bidireccionalmente). Agrupa por tipo cooperación, calcula porcentaje éxito dividiendo completadas entre total.",
  ...
  },
  {
    ...
    descripcion: "CTE AvistamientosAmenaza filtra RobotSightings WHERE NivelAmenaza≥7. JOIN con Attacks usando DATEDIFF para calcular días entre avistamiento y ataque. Filtra WHERE ataque≥avistamiento Y diferencia≤10 días. Clasifica patrón temporal.",
  ...
  },
  {
    ...
    descripcion: "Dos CTEs: NecesidadRecursos (calcula necesidades: personal×100 comida, ×20 medicinas) y SuministrosRecientes (suma entregas desde julio 2025). LEFT JOIN entre CTEs, compara necesidades vs disponible para detectar déficit.",
  ...
  },
  {
    ...
    descripcion: "JOIN de DistanceMatrix (dm) con Bases origen (bo) y destino (bd), LEFT JOIN con Missions (m). Clasifica rutas por kilómetros, cuenta misiones realizadas, calcula porcentaje éxito dividiendo completadas/total. Ordena por uso y distancia.",
  ...
  },
  {
    ...
    descripcion: "CTE BaseSeguridad: LEFT JOIN múltiple de Bases con Survivors, Attacks, RobotSightings, Alliances, Resources. Cuenta eventos por base, calcula índice con algoritmo: (+personal×15 +alianzas×20 +armas/10) - (ataques×15 +avistamientos×5 +amenaza×2). Limita 0-100.",
  ...
  },
  {
    ...
    descripcion: "Tres CTEs: PoderMilitar (personal, comandantes, armas, suministros), InfluenciaEstrategica (alianzas, misiones, confianza), VulnerabilidadOperacional (ataques, avistamientos, distancias). JOIN entre CTEs, algoritmo poder integral con múltiples factores ponderados.",
...
function verificarReto(consultaEjecutada, resultados) {
    ...
    // Nueva verificación basada en comparación de resultados
    return verificarPorComparacionResultados(retoActualStorage, consultaEjecutada, resultados);
}

async function verificarPorComparacionResultados(reto, consultaUsuario, resultadosUsuario) {
    try {
        // Ejecutar la consulta sugerida del reto para obtener el resultado correcto
        const response = await fetch('api/sql_proxy.php', {
            method: 'POST',
            headers: {
        ...
        // Comparar resultados
        if (compararResultados(resultadosUsuario, resultadosCorrectos)) {
            // ¡Reto completado!
            const puntos = reto.puntos || 10;
            
            // Llamar a la función completarReto para desbloquear el siguiente
            completarReto(reto.id, puntos);
            ...
            return {
                completado: true,
                mensaje: `🎉 ¡RETO #${reto.id} COMPLETADO! 🎉\n\n` +
                        `"${reto.titulo}"\n\n` +
...
function compararResultados(resultados1, resultados2) {
    ...
    for (let i = 0; i < resultados1.length; i++) {
        const fila1 = resultados1[i];
        const fila2 = resultados2[i];
        
        // Comparar cada valor en la fila
        for (const columna of columnas1) {
            const valor1 = normalizeValue(fila1[columna]);
            const valor2 = normalizeValue(fila2[columna]);
